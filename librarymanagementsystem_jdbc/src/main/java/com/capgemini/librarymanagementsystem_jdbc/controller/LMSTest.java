...
import com.capgemini.librarymanagementsystem_jdbc.service.LMSUsersService;
import com.capgemini.librarymanagementsystem_jdbc.validation.LMSValidation;
								...
								if (loginInfo.getRole().equals("admin")) {
									do {
										try {
											...
											case 6:
												try {
													LinkedList<LMSBookDetails> info = service1.getBooksInfo();
											...
											case 9:
												...
												try {
													List<LMSBookIssueDetails> uid = service1
															.bookHistoryDetails(user_Id);
													for (LMSBookIssueDetails issueDetails : uid) {
